...
오픈소스 DBMS인 MySQL과 PostgreSQL 중 어떤 DBMS을 사용할지는 프로젝트 요구 사항, 애플리케이션 특성, 그리고 개발팀의 경험과 선호도에 따라 달라집니다. 그런데도 많은 사람들이 자신의 서비스에 MySQL과 PostgreSQL 중 어느 것이 더 적합할지 판단하기가 여전히 어렵습니다.
