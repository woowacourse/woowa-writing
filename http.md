...
​  
그렇기에, http2로 개선하면 어느정도 개선이 될 것이라고 생각했습니다.
​
...
각각의 요청이 http/1.1로 되고 있는 모습 / 이미지들의 요청 순서
...
따라서, HOL(Head Of Line) Blocking 즉, "특정 응답 지연"문제가 발생합니다.  
​  
...
​
그리고, 다시 1954035에 가면, "source_dependency"가 195417 SOCKET으로 연결되어 있는 것을 확인할 수 있습니다.  
