# Server-Sent Event(SSE)로 서버에서 이벤트 보내기
...
이런 **즉시 반응하는 경험**은 이제 너무 당연해서, 없으면 오히려 이상하게 느껴집니다.
...
## 3. Spring에서는 SSE를 어떻게 사용할 수 있을까?
