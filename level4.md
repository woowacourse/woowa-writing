...
<img src="review_me_oop_trial.png">
...
예를 들어, SOLID 중 S에 해당하는 단일 책임 원칙을 지키기 위해 도메인과 관련된 로직을 도메인 안에 넣었습니다. 그랬더니 비지니스 정책이 바뀔 때마다 도메인이 달라져야 했습니다. 그뿐 아니라, JPA 에서는
FK 를 저장해야 한다는 이유로 객체를 직접 참조합니다.
...
<img src="review_me_4th_demoday_erd.png">
