...
프로토타입을 AWS 인프라로 마이그레이션하는 일만 남았는데요.
...
코스잇다에 Terraform을 도입하고 학습하면서 "이 정도만 이해하고 있어도 누구든 충분히 Terraform을 사용할 수 있겠다" 느꼈던 내용들을 공유하고자 정리해 보았습니다.

Terraform을 처음 접하거나, 제 상황처럼 소규모의 서비스에 도입하려는 분들께 도움이 되길 바랍니다. 😄
