# 좋은 API 설계하기: 추상화 레벨이 모든 것을 결정한다
...
그 이후로 여러 사례를 살펴보며 이 찝찝함의 정체를 파악하기 시작했습니다. GitHub는 어떻게 PR API를 설계했을까? Stripe는 다양한 결제 수단을 어떻게 통합했을까? 이런 질문들을 추적하면서 점점 명확해진 것이 있습니다.
