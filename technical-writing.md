...
- 리액트 19.2 버전의 신기능인 Activity에 대해 알아보고 싶은 분들
- 조건에 따라 표시되는 UI를 리액트로 만들어보고 싶은 분들
  - 해당 UI를 만들었는데, 새롭게 표시할 때마다 기존 값이 초기화되어 어려움을 겪고 있는 분들
- 내 프로젝트에 어떻게 Activity를 녹여낼 수 있을까 고민을 하고 계신 분들

<br />

## Activity란?

**Activity는 조건에 따라 특정 UI의 표시여부를 다루는 리액트 컴포넌트**입니다.
