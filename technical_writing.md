...
현재 모모 서비스는 예약을 생성하는 과정에서 날짜들을 생성하는 경우 BatchSize를 30, 일정을 생성하는 경우 BatchSize를 50으로 설정하였습니다. Batch Processing의 철학을 고려해보면 현재보다 사이즈를 크게 설정해도 무리가 없을 것으로 예상하지만,
