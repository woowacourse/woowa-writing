...
이 Context는 Activity에서도 존재하고, 또 접근하여 사용할 수 있습니다.

소설과 영화에서는 챕터 또는 장면으로 구분된 크고 작은 사건들이 일어납니다.  
이야기에서 사건이 진행될 때 부가적인 정보가 필요합니다.
사건이 일어난 배경과 상황이 있을 것이고, 이번 사건으로 또 다른 사건이 파생될 수도 있습니다.
새로운 등장 인물이 나타나거나, 사건 해결의 실마리를 던져주는 장치가 필요할 수도 있습니다.  
이렇듯, 사건도 맥락이 존재합니다.
