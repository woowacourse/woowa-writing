...
해당 미션에서 장기 보드와 기물과 사이의 관계를 구현하면서 테스트 주도 개발을 실천해보았는데, 오히려 테스트 주도 개발이 설계의 방향성을 잡아주고 책임의 명확한 분리를 유도했습니다. 여전히 테스트를 작성하는 속도는 느리긴 했습니다만, 테스트 주도 개발에서 테스트 작성에 드는 시간은 ‘필요 낭비’입니다. 이는 테스트 작성에 드는 시간은 낭비가 아니라는 말입니다. 그리고 많은 개발자들이 말하지만, 이건 테스트를 더 빠르게 작성하면 되는 문제였습니다. 물론 그만큼 테스트를 많이 작성해야 속도가 늘긴 하겠지요.

이러한 경험을 통해 테스트와 객체지향에 대해 관심을 갖게 되었습니다. 그래서 테스트 주도 개발에 대해 모르시거나 알지만 해당 개발론의 감동을 느껴보지 못한 분들을 위해 해당 글을 작성하게 되었습니다.
...
실존주의에서 핵심적인 말이죠. 위의 단점들을 감안하더라도 여전히 테스트 주도 개발은 강력한 개발 방법론입니다. 중요한 것은 모든 상황에 적용하는 것이 아니고, 요구사항의 특성과 상황을 고려해 적절하게 활용하는 것입니다. 이번 기회로 많은 분들이 테스트 주도 개발에 관심을 갖고 실천해보셨으면 합니다.
