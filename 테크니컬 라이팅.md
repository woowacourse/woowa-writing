...
해당 함수에서 `lane`이라는 용어가 등장한다.

이는 동시성에서 사용되는 우선순위와 관련한 중요 개념이므로 추후에 기술한다.
...
<img width="748" alt="스크린샷 2024-10-01 오후 3 37 58" src="https://github.com/user-attachments/assets/f60afcb7-cc3e-402a-b24e-431b1a4739aa">

> 실제 Scheduler 패키지의 구현체 코드는 다음 테크니컬 회차때 기술 예정
